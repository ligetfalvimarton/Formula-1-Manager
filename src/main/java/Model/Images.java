...
public enum Images {
    ...
    FLAG1(Paths.get("").toAbsolutePath().toString() + "/src/main/java/Images/flag1.png"),
    FLAG2(Paths.get("").toAbsolutePath().toString() + "/src/main/java/Images/flag2.png"),
    FLAG3(Paths.get("").toAbsolutePath().toString() + "/src/main/java/Images/flag3.png"),
    FLAG4(Paths.get("").toAbsolutePath().toString() + "/src/main/java/Images/flag4.png"),
